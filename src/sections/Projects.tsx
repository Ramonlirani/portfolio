...
// mocks
import { PROJECTS, PROJECT_CATEGORY, TABS } from "../mocks/projects";
...
export default function Projects() {
   ...
   const handleOnClick = (_value: any) => {
   ...
   return (
      <>
         <section className="container mx-auto mt-16 space-y-10 pb-16 sm:pb-16 pr-3 pl-3 md:space-x-0">
            ...
            <LoadAnimate amount={0}>
               <div className="flex w-full flex-col items-center">
                  <ul
                     id="projects-tab"
                     className="-mb-px flex gap-x-2 border-b border-gray-200 font-medium  hover:cursor-pointer dark:border-gray-700"
                  >
                     {TABS.map((tab, i) => (
                        <li
                           key={`tab ${i}`}
